...
const rows=JSON.parse(fs.readFileSync('public/catalog.json')).rows.filter(r=>r.stock&&r.url&&r.name!=='Unnamed variant').map(r=>{const g={...r,...classify(r)};return {...g,...apparel(g),...sizing(g)}});
